        ...
        <svg class="logo-abbr" xmlns="http://www.w3.org/2000/svg" width="62.074" height="65.771"
            ...
            <g id="search_11_" data-name="search (11)" transform="translate(12.731 12.199)">
                <rect class="rect-primary-rect" id="Rectangle_1" data-name="Rectangle 1" width="60" height="60" rx="30"
                    transform="translate(-10.657 -12.199)" fill="#f73a0b"></rect>
                <path id="Path_2001" data-name="Path 2001"
                    ...
                    transform="translate(1 0)" fill="#fff" stroke="#fff" stroke-width="1"></path>
                <path id="Path_2002" data-name="Path 2002"
                    ...
                    transform="translate(-168.591 -98.178)" fill="#fff" stroke="#fff" stroke-width="1"></path>
            </g>
        </svg>
        <svg class="brand-title" xmlns="http://www.w3.org/2000/svg" width="134.01" height="48.365"
            ...
            <g id="Group_38" data-name="Group 38" transform="translate(-133.99 -40.635)">
                ...
                <path id="Path_1948" data-name="Path 1948"
                    ...
                    transform="translate(133.63 53.217)" fill="#464646"></path>
            </g>
        </svg>
    </a>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="22.871" viewbox="0 0 24 22.871">
                                <g data-name="Layer 2" transform="translate(-2 -2)">
                                    ...
                                    <path id="Path_10" data-name="Path 10"
                                        ...
                                        transform="translate(-0.45 -0.63)"></path>
                                    <path id="Path_11" data-name="Path 11"
                                        d="M16.1,13H7.91a.91.91,0,1,0,0,1.82H16.1a.91.91,0,1,0,0-1.82Z"
                                        transform="translate(-0.45 -0.99)"></path>
                                </g>
                            </svg>
