                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row separate-row">
                                            ...
                                            <div class="col-sm-6">
                                                <div
                                                    class="job-icon pt-4 pb-sm-0 pb-4 pe-3 d-flex justify-content-between">
                                                    <div>
                                                        <div class="d-flex align-items-center mb-1">
                                            ...
                                            <div class="col-xl-8 col-xxl-7 col-sm-7">
                                                <div class="update-profile d-flex">
                                                    ...
                                                    <div class="ms-4">
                                                        ...
                                                        <span><i class="fas fa-map-marker-alt me-1"></i>Medan, Sumatera
                                                            Utara -
                                                            ID</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xl-6 col-sm-6">
                                                ...
                                                <div class="d-flex align-items-end mt-2 pb-4 justify-content-between">
                                                    ...
                                                    <span class="fs-16"><span
                                                            class="text-black pe-2"></span>90%</span>
                                                </div>
                                                <div class="progress default-progress">
                                                ...
                                                <div class="d-flex align-items-end mt-2 pb-4 justify-content-between">
                                                    ...
                                                    <span class="fs-16"><span
                                                            class="text-black pe-2"></span>68%</span>
                                                </div>
                                                <div class="progress default-progress">
                                                ...
                                                <div class="d-flex align-items-end mt-2 pb-4 justify-content-between">
                                                    ...
                                                    <span class="fs-16"><span
                                                            class="text-black pe-2"></span>85%</span>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-sm-6">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body loadmore-content  recent-activity-wrapper"
                                        ...
                                        <div class="d-flex recent-activity">
                                            ...
                                            <div class="ms-3">
                                                <h5 class="mb-1">Bubles Studios have 5 available positions for
                                                    you</h5>
                                                <span>8min ago</span>
                                            </div>
                                        </div>
                                        <div class="d-flex recent-activity">
                                            ...
                                            <div class="ms-3">
                                                <h5 class="mb-1">Elextra Studios has invited you to interview
                                                    meeting tomorrow</h5>
                                                <span>8min ago</span>
                                            </div>
                                        </div>
                                        <div class="d-flex recent-activity">
                                            ...
                                            <div class="ms-3">
                                                <h5 class="mb-1">Highspeed Design Team have 2 available positions
                                                    for you</h5>
                                                <span>8min ago</span>
                                            </div>
                                        </div>
                                        <div class="d-flex recent-activity">
                                            ...
                                            <div class="ms-3">
                                                <h5 class="mb-1">Kleon Studios have 5 available positions for you
                                                </h5>
                                                <span>8min ago</span>
                                            </div>
                                        </div>
                                                                ...
                                                                <g transform="translate(-457 -443)">
                                                                    ...
                                                                    <g transform="translate(457 443)">
                                                                        ...
                                                                        <circle data-name="Ellipse 11" cx="11" cy="11"
                                                                            r="11" transform="translate(36 15)"
                                                                            fill="#ffe70c"
                                                                            style="mix-blend-mode: multiply;isolation: isolate">
                                                                        </circle>
                                                                    </g>
